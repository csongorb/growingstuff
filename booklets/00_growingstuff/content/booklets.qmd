...
This last one troubles me. I want to have some kind of overarching thing that summarizes things, but I can't find the form. A *catalog*, a *meta* booklet. The issue feels similar to `onstage.md`. Is it ok to just include this dialogue? Is it enough? Too self-referential? How to contextualize it? A *curator's note*, an *introduction* by someone else...? Who?
...
Maybe its time again for a *song*^[The Strokes. (2001) 'Take It or Leave It', Is This It. Rough Trade Records. [youtube.com/watch?v=C0qls7b5oAY](https://www.youtube.com/watch?v=C0qls7b5oAY)]
