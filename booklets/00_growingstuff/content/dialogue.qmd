# dialogue.md {#sec-dialogue}

## 2025-01-08 Csongor

Hey Pippin,  
I guess we need to *start it somewhere,  
so le's start it*^[Pulp. (1995) 'Common People', Different Class. Island Records. [youtube.com/watch?v=lkpLbEM06qE](https://www.youtube.com/watch?v=lkpLbEM06qE)] here.
...
It is inspiring to see you *working*^[[github.com/pippinbarr/it-is-as-if-you-were-on-your-phone/commits/main](https://github.com/pippinbarr/it-is-as-if-you-were-on-your-phone/commits/main/)] and *reflecting*^[[github.com/pippinbarr/it-is-as-if-you-were-on-your-phone/blob/main/process/journal.md](https://github.com/pippinbarr/it-is-as-if-you-were-on-your-phone/blob/main/process/journal.md)] next to us... don't feel watched! What does this do to us? I for sure feel strange observing you from a distance.
...
[I OOPed in the code pool; I wanna be an FSM (2025-01-28)](https://github.com/pippinbarr/it-is-as-if-you-were-on-your-phone/blob/main/process/journal.md#i-ooped-in-the-code-pool-i-wanna-be-an-fsm-2025-01-28)^[[github.com/pippinbarr/it-is-as-if-you-were-on-your-phone/blob/main/process/journal.md#i-ooped-in-the-code-pool-i-wanna-be-an-fsm-2025-01-28](https://github.com/pippinbarr/it-is-as-if-you-were-on-your-phone/blob/main/process/journal.md#i-ooped-in-the-code-pool-i-wanna-be-an-fsm-2025-01-28)]
...
In this sense, are your [v r](https://pippinbarr.com/ideas/v-r/) series also works like this, or are they not (see my quote from one of your journals above)? Do they need less explanation, less accompanying text? 
...
Aaaand yesss, let's integrate your drawings...! But we need them in good quality. [Your Insta](https://www.instagram.com/pippinbarr/)^[[instagram.com/pippinbarr](https://www.instagram.com/pippinbarr/)] has a good amount, but it does not really allow us to download them and the quality is always restricted. Also, do you have more (maybe even design-related)?  
...
Haha, I have just edited the `/booklets/00_growingstuff/content/dialogue.qmd` file first, a perfect glitch for this message!
...
Aaand *this* repository would be a logical place for that. We would use the Player of the [Devolutionizer](https://github.com/csongorb/devolutionizer)^[[github.com/csongorb/devolutionizer](https://github.com/csongorb/devolutionizer)] for this, it's already in a nice shape, we'll try to improve it even more. This all means that there would be some sort of hub / sidebar where people could select the versions they want to play. 
