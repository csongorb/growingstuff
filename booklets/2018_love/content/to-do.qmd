...
- Create basic arousal number that goes up with correct sliding and words
...
- ~~**IT'S BETTER IN THE PANEL I THINK** Highlight the setting to slider to on the slider (try this over the version where it's in the panel)~~
...
- Think about sound issues on iOS - test whether you can trigger sounds in slide event (guess it's maybe a version of mouse-moved?)
- Can you bear trying to restyle jQuery version of radio buttons to have them look more 'authentic'? (Almost certainly not.)

---

- ~~Write a journal entry about sounds to figure out how they'll work~~
- ~~Add sounds from Win 2000~~
- ~~**INDEED YOU NEED AN EVENT TO TRIGGER IT** Check iOS audio triggering issues on actual device~~
